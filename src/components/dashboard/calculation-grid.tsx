    ...
    <section id="grid" className="scroll-mt-20">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
        {calculationModules.map((module) => (
          <Card key={module.id} className="transition-all hover:shadow-lg hover:-translate-y-1">
            ...
            <CardContent>
              ...
              {module.change && (
                <p className={cn("text-xs", module.changeType === 'positive' ? 'text-green-600' : 'text-destructive')}>
