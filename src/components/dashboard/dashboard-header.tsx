...
export function DashboardHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between gap-4 border-b border-primary/20 bg-background/50 backdrop-blur-sm px-4 md:px-6">
        <WorldClocks />
