...
// Initialize Firebase Admin (assuming default credentials or already authenticated environment)
...
async function audit() {
    ...
    if (closeSnap.exists) {
        ...
        console.log(`UpdatedAt: ${data?.retrievedAt ? data.retrievedAt.toDate().toISOString() : 'N/A'}`);
